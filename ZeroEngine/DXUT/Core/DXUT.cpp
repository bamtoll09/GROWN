...
void WINAPI DXUTSetCursorSettings( bool bShowCursorWhenFullScreen, bool bClipCursorWhenFullScreen, bool bClipCursorWhenWindowScreen )
{
	...
	ShowCursor( bClipCursorWhenWindowScreen );
    DXUTSetupCursor();
}
